...
public class PlayerChefView extends JPanel implements ActionListener {
	...
	private JRadioButton redPlateChooser;
	private JRadioButton bluePlateChooser;
	private JRadioButton goldPlateChooser;
	private JRadioButton greenPlateChooser;
	...
	public PlayerChefView(int belt_size) {
		...
		// JButton sashimi_button = new JButton("Make red plate of crab sashimi
		// at position 3");
		...
		//
		// JButton nigiri_button = new JButton("Make blue plate of eel nigiri at
		// position 8");
		...
		// add(Box.createVerticalStrut(20));
		//
		// JButton roll_button = new JButton("Make gold plate of KMP roll at
		// position 5");
		...
		positionJapanel.add(new JLabel("position:"));
		...
		avocado_oz_text = new JTextField(2);
		crab_oz_text = new JTextField(2);
		eel_oz_text = new JTextField(2);
		rice_oz_text = new JTextField(2);
		salmon_oz_text = new JTextField(2);
		seaweed_oz_text = new JTextField(2);
		shrimp_oz_text = new JTextField(2);
		tuna_oz_text = new JTextField(2);
