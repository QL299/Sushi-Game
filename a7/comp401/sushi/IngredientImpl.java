...
abstract public class IngredientImpl implements Ingredient {
	...
	protected IngredientImpl(String name, double price, int calories, boolean is_vegetarian, boolean is_rice,
	...
	public boolean equals(Ingredient other) {
		...
		return ((other == this)
				|| (other.getName().equals(getName()) && (other.getCaloriesPerOunce() == getCaloriesPerOunce())
						&& (Math.abs(other.getPricePerOunce() - getPricePerOunce()) < 0.01)
						&& (other.getIsVegetarian() == getIsVegetarian()) && (other.getIsRice() == getIsRice())
